...
# IO TESTING                        #
# ================================= #
@pytest.mark.parametrize('protocol, from_method, to_method', __coordinate_system_io_protocols__)
def test_coordinate_system_io(cs_flag,
                                   coordinate_systems,
    ...
    assert hasattr(coordinate_system, from_method), "No method to read coordinate system from disk."
    assert hasattr(coordinate_system, to_method), "No method to write coordinate system to disk."

    _from_method,_to_method = getattr(coordinate_system, from_method), getattr(coordinate_system, to_method)
